...
void Fun4All_G4_MyZDC_Cone(int nEvents = 10000)
{
  ///////////////////////////////////////////
  // Make the Server
  //////////////////////////////////////////
  ...
  mydet->set_double_param("place_z",3750.);
  ...
  cout<<endl;
  cout<< "My Setup: " <<particle<< "  with "<<mom<<" GeV"<<endl;
  cout<<endl;
  gSystem->Exit(0);
}
