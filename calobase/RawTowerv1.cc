...
int RawTowerv1::get_bineta() const
{
  ...
  case RawTowerDefs::ZDC_Crystal:
  case RawTowerDefs::ZDC_SiPixel:
  case RawTowerDefs::ZDC_SiPad:
  case RawTowerDefs::ZDC_Sci:
    return RawTowerDefs::decode_index1zdc(towerid); 
  case RawTowerDefs::LFHCAL:
...
int RawTowerv1::get_binphi() const
{
  ...
  case RawTowerDefs::ZDC_SiPad:
  case RawTowerDefs::ZDC_Sci:
    return RawTowerDefs::decode_index2zdc(towerid);
  case RawTowerDefs::LFHCAL:
...
int RawTowerv1::get_binl() const
{
  ...
  case RawTowerDefs::ZDC_SiPad:
  case RawTowerDefs::ZDC_Sci:
    return RawTowerDefs::decode_index3zdc(towerid);
  default:
    return RawTowerDefs::decode_index3v2(towerid);
  }
  return -1;
}
